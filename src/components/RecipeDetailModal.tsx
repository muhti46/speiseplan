      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="mb-4 flex items-center gap-2 text-sm text-slate-600">
            ...
            Portionen: {DEFAULT_PORTIONS - 1}–{DEFAULT_PORTIONS + 1} Personen
          </div>
          ...
          <div className="mb-5 grid grid-cols-3 gap-2 rounded-xl bg-slate-50 p-3 text-center">
            <div>
              ...
              <p className="text-xs text-slate-500">Zubereitung</p>
            </div>
            <div>
              ...
              <p className="text-xs text-slate-500">Kochen</p>
            </div>
            <div>
              ...
              <p className="text-xs text-slate-500">Gesamtzeit</p>
            </div>
          </div>

          <section className="mb-5">
            <h3 className="mb-2 text-sm font-semibold uppercase tracking-wide text-slate-400">Zutaten</h3>
